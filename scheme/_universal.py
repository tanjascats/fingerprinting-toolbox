...
class BNNScheme(Scheme):
    ...
    def __init__(self, gamma, xi, fingerprint_bit_length=32, secret_key=333, number_of_buyers=10, distance_based=False,
                 d=0, k=10):
        self.gamma = gamma
        self.xi = xi
        self.distance_based = distance_based  # if False, then fixed-size-neighbourhood-based with k=10 - default
    ...
    def detection(self, dataset_name, real_buyer_id, secret_key=None, dataset=None):
        ...
        tot_attributes = len(relation_fp.columns) - 1
