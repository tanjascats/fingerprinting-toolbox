...
# gamma = 5
y[0] = np.flip(np.array([250, 250, 250, 250, 243, 232, 226, 201, 0]))
# ----------------------------------------------------------------------------- #
# ----------------------------------------------------------------------------- #
# gamma = 10
y[1] = np.flip(np.array([250, 250, 247, 230, 190, 163, 127, 87, 0]))
# ----------------------------------------------------------------------------- #
# ----------------------------------------------------------------------------- #
# gamma = 20
y[2] = np.flip(np.array([250, 231, 185, 111, 63, 34, 26, 7, 0]))
# ----------------------------------------------------------------------------- #
# ----------------------------------------------------------------------------- #
# gamma = 30
y[3] = np.flip(np.array([250, 167, 73, 28, 17, 16, 6, 4, 0]))
