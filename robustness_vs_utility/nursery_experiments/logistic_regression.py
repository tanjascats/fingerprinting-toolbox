...
def demo_exp(gamma, n_removed_attr):  # [20, 10, 7, 3]
    ...
    accuracy_original = 0.8449845679012346  # {'C': 20, 'solver': 'newton-cg'}
    ...
    for attr_combination in attributes:
        ...
        for n in range(n_exp):
            ...
            if attr_combination[0] is 'full':
                ...
                model = LogisticRegression(random_state=random_state, C=20, solver='newton-cg')
                ...
                model2 = LogisticRegression(random_state=random_state, C=20, solver='newton-cg')
...
def feature_selection(gamma):
    ...
    for e in range(n_exp):
        ...
        for n_features in range(1, len(fp_dataset.columns)):
            ...
            model = LogisticRegression(random_state=0, C=20, solver='newton-cg')
...
if __name__ == '__main__':
    ...
    # save results
    outfile = open(
        'robustness_vs_utility/nursery_experiments/horizontal_with_imputation_logistic_regression_' + str(gamma), 'wb')
