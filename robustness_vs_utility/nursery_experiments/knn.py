...
def transferable_feature_selection(gamma):
    ...
    for e in range(n_exp):
        ...
        for n_features in range(1, len(fp_dataset.columns)):
            ...
            new_model = KNeighborsClassifier(n_neighbors=24, algorithm='ball_tree')
            # define new target
...
if __name__ == '__main__':
    ...
    # save results
    outfile = open('robustness_vs_utility/nursery_experiments/horizontal_with_imputation_knn_' + str(gamma),
                   'wb')
