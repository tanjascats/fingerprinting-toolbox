...
def demo_exp(gamma, n_removed_attr):
    ...
    accuracy_original = 0.753  # for logistic regression: C=10, solver='liblinear'
    ...
    for attr_combination in attributes:
        ...
        for n in range(n_exp):
            ...
            if attr_combination[0] is 'full':
                ...
                model = LogisticRegression(random_state=random_state, C=10, solver='liblinear')
                ...
                model2 = LogisticRegression(random_state=random_state, C=10, solver='liblinear')
...
def horizontal_attack(gamma, percentage_removed, results):
    ...
    for e in range(n_exp):
        ...
        model = LogisticRegression(random_state=0, C=10, solver='liblinear')
...
if __name__ == '__main__':
    ...
    # save results
    outfile = open('robustness_vs_utility/german_credit_experiments/bit-flip_logistic_regression_' + str(gamma), 'wb')
