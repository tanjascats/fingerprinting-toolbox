...
def demo_exp(gamma, n_removed_attr):  # [20, 10, 7, 3]
    ...
    accuracy_original = 0.71428571428571  # for decision tree: max_depth = 9, criterion = 'entropy'
    ...
    for attr_combination in attributes:
        ...
        for n in range(n_exp):
            ...
            if attr_combination[0] is 'full':
                ...
                model = DecisionTreeClassifier(random_state=random_state, criterion='entropy', max_depth=9)
                ...
                model2 = DecisionTreeClassifier(random_state=random_state, criterion='entropy', max_depth=9)
...
if __name__ == '__main__':
    ...
    # save results
    outfile = open('robustness_vs_utility/german_credit_experiments/bit-flip_decision_tree_' + str(gamma), 'wb')
