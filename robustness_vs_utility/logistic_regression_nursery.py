...
print("\t-best parameters: {'solver':'lbfgs', 'C':20}")
print("\t-best accuracy score: 0.8408")
...
for n in range(n_exp):
    ...
    model2 = LogisticRegression(random_state=random_state, solver='lbfgs', C=20)
    ...
    for remove in removes:
        ...
        for attribute_combination in combinations_to_consider:
            ...
            model3 = LogisticRegression(random_state=random_state, solver='lbfgs', C=20)
