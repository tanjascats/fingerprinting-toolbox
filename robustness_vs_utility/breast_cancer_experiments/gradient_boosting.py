    ...
    for attr_combination in attributes:
        ...
        for n in range(n_exp):
            ...
            if attr_combination[0] is 'full':
                ...
                model = GradientBoostingClassifier(random_state=random_state, n_estimators=200, loss='exponential',
                                                   criterion='mae')
...
def horizontal_attack(gamma, percentage_removed, results):
    ...
    for e in range(n_exp):
        ...
        model = GradientBoostingClassifier(random_state=0, n_estimators=200, loss='exponential', criterion='mae')
...
if __name__ == '__main__':
    ...
    # save results
    outfile = open('robustness_vs_utility/breast_cancer_experiments/bit-flip_gradient_boosting_' + str(gamma), 'wb')
