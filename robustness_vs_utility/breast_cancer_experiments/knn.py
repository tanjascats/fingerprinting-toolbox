    ...
    for attr_combination in attributes:
        ...
        for n in range(n_exp):
            ...
            if attr_combination[0] is 'full':
                ...
                model = KNeighborsClassifier(n_neighbors=19, algorithm='kd_tree')
                ...
                model2 = KNeighborsClassifier(n_neighbors=19, algorithm='kd_tree')
...
if __name__ == '__main__':
    ...
    # save results
    outfile = open('robustness_vs_utility/breast_cancer_experiments/bit-flip_knn_' + str(gamma), 'wb')
