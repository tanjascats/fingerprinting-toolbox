...
# n_est=40, max_depth=8, loss0deviance, criterion=mse
...
def feature_selection(gamma):
    ...
    for e in range(n_exp):
        ...
        for n_features in range(1, len(fp_dataset.columns)):
            ...
            model = GradientBoostingClassifier(random_state=0, n_estimators=40, max_depth=8, loss='deviance',
                                               criterion='mse')
...
if __name__ == '__main__':
    ...
    # save results
    outfile = open('robustness_vs_utility/adult_experiments/bit-flip_gradient_boosting_' + str(gamma), 'wb')
