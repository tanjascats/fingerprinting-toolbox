...
def feature_selection(gamma):
    ...
    for e in range(n_exp):
        ...
        for n_features in range(1, len(fp_dataset.columns)):
            ...
            model = LogisticRegression(random_state=0, C=20, solver='liblinear')
...
if __name__ == '__main__':
    ...
    # save results
    outfile = open('robustness_vs_utility/adult_experiments/bit-flip_logistic_regression_' + str(gamma), 'wb')
