...
print("\t-best parameters: {'max_depth': 20, 'criterion': 'entropy'}")
print("\t-best accuracy score: 0.7829475308641975")
print("\t-best classifier: DecisionTreeClassifier(class_weight=None, criterion='entropy', max_depth=20, "
      "max_features=None, max_leaf_nodes=None, min_impurity_decrease=0.0, min_impurity_split=None, min_samples_leaf=1, "
      "min_samples_split=2, min_weight_fraction_leaf=0.0, presort=False, random_state=18, splitter='best')")
...
for n in range(n_exp):
    ...
    model2 = DecisionTreeClassifier(random_state=random_state, criterion='entropy', max_depth=20)
    ...
    for remove in removes:
        ...
        for attribute_combination in combinations_to_consider:
            ...
            model3 = DecisionTreeClassifier(random_state=random_state, criterion='entropy', max_depth=20)
