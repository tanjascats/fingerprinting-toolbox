...
for n in range(n_exp):
    ...
    # 3.2) train
    model = GradientBoostingClassifier(criterion=best_params['criterion'], loss=best_params['loss'],
    ...
    # 6.3) train the model
    model2 = GradientBoostingClassifier(criterion=best_params['criterion'], loss=best_params['loss'],
                                        n_estimators=best_params['n_estimators'], random_state=0)
